...
import TippyPopper from '../Poper/TippyPopper';
...
function Header() {
    ...
    return <header className={cx('wrapper')} >
        <div className={cx('inner')} >
            <Link to={routesConfig.home}>
                <div className={cx('logo')} >
                    <svg height="42" width="118" alt="TikTok">
                        <g clipPath="url(#clip0)"><path d="M9.87537 16.842V15.7233C9.49211 15.6721 9.10246 15.6401 8.70003 15.6401C3.90288 15.6338 0 19.5399 0 24.3475C0 27.2947 1.46917 29.9031 3.71764 31.4822C2.26763 29.9287 1.37974 27.8381 1.37974 25.5494C1.37974 20.8121 5.17403 16.9507 9.87537 16.842Z" fill="#25F4EE"></path>
            ...
            {/* action */}
            {/* neu co user thi hien current user ko co thi hien login */}
            <div className={cx('action')} >
                ...
                <TippyPopper items = {currentUser ? userMenu : MENU_ITEMS} onChange ={handleOnChange} >
                    {currentUser ? (
                        <Image 
                            className={cx('avatar-user')} 
                            alt='user' 
                            src='https://photo-resize-zmp3.zmdcdn.me/w360_r1x1_jpeg/avatars/9/8/4/d/984de8b3596498462d5f954eadbb1f47.jpg' 
                        />
                    ) : (
